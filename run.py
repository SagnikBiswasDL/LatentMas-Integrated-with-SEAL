...
def main():
    ...
    # SEAL steering
    parser.add_argument("--use_seal", action="store_true", help="Enable SEAL latent steering during LatentMAS")
    parser.add_argument("--seal_vector_path", type=str, default="artifacts/seal_vectors/qwen3-14b/layer_28_steervec.pt")
    parser.add_argument("--seal_layer", type=int, default=28)
        ...
        json.dumps(
            {
                ...
                "use_seal": bool(getattr(args, "use_seal", False)),
